...
//  LoveHome
//
//  Created by Joe Chen on 14/11/20.
                                    ...
                                    andFailedCallback:(HttpServiceBasicFailBackBlock)failedCallback
{
    if (urlString && [urlString length] > 0)
    {
        ...
        {
            request = [manager.requestSerializer multipartFormRequestWithMethod:requestMethodsStr
...
//        }
        ...
        AFHTTPRequestOperation *operation = [manager HTTPRequestOperationWithRequest:request success:^(AFHTTPRequestOperation *operation, id responseObject) {
            ...
            if (error.code == -1004 ) {
                 myError = [JXError errorWithCode:JXErrorCodeNetworkDisable description:@"无网络信号,请稍后再试"];
            }
            else
            {

...
- (instancetype)init {
    if (self = [super init]) {
        ...
        _isReceiptPromptClosed = [userDefaults boolForKey:kUdReceiptPromptClosed];
...
- (void)storage {
    ...
    [userDefaults setBool:_isReceiptPromptClosed forKey:kUdReceiptPromptClosed];
    [userDefaults synchronize];
    
    [LHUser storage:self.user];
    [LHCartShop storage:self.cartShops];
    [LHReceipt storage:_receipt];
}

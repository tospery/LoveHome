...
#define kUdReceiptPromptClosed          (@"kUdReceiptPromptClosed")         // 账号
...
#define kHTTPBase                   (@"http://ivhome-test.appvworks.com/appvworks.portal")
...
#define kNotifyWxpayPayment                 (@"kNotifyWxpayPayment")
...
#define kNotifyLoginSuccess                 (@"kNotifyLoginSuccess")
#define kNotifyAddressChoosed               (@"kNotifyAddressChoosed")
#define kNotifyOnlineGoodsDeleted           (@"kNotifyOnlineGoodsDeleted")
#define kNotifyOnlineGoodsOrdered           (@"kNotifyOnlineGoodsOrdered")
...
// 其他
#define  kIsLocalCart                   ([gLH.receipt.receiptID isEqualToString:@"-77"])
#define  kIsInvalidCart                 (gLH.receipt.receiptID.length == 0)

#define kProductNotSpecify              (@"默认规格")

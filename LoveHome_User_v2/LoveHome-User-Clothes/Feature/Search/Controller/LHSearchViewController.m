    ...
    switch (mode) {
        case JXWebLaunchModeLoad: {
            ...
            [self.operaters exAddObject:
             [LHHTTPClient searchShopsWithLatitude:gLH.receipt.latitude longitude:gLH.receipt.longitude name:name distance:30000.0f sort:1 index:1 size:_page.pageSize success:^(AFHTTPRequestOperation *operation, LHShopList *shopList) {
        ...
        case JXWebLaunchModeMore: {
            [self.operaters exAddObject:
             [LHHTTPClient searchShopsWithLatitude:gLH.receipt.latitude longitude:gLH.receipt.longitude name:name distance:30000.0f sort:1 index:(_page.currentPage + 1) size:_page.pageSize success:^(AFHTTPRequestOperation *operation, LHShopList *shopList) {

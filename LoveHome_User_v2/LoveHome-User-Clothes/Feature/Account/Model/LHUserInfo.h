...
@property (nonatomic, assign) NSInteger orderToPayCount;        // 订单待支付数量
@property (nonatomic, assign) NSInteger orderToAcceptCount;     // 订单待服务数量
@property (nonatomic, assign) NSInteger orderAcceptedCount;     // 订单服务中数量
@property (nonatomic, assign) NSInteger orderFinishCount;       // 订单已完成数量

...
typedef NS_ENUM(NSInteger, DOPDropDownMenuSeparatorType){
    DOPDropDownMenuSeparatorTypeArrow,
    DOPDropDownMenuSeparatorTypeTriangle
};
...
@property (nonatomic, assign) BOOL hideMiddleSeperator;
@property (nonatomic, assign) DOPDropDownMenuSeparatorType separator;

...
-(void)initializeViewComponents{
    ...
    //Page Control
    self.PageControl = [[UIPageControl alloc] initWithFrame:CGRectMake((self.frame.size.width - kPageControlWidth)/2, self.frame.size.height - 44, kPageControlWidth, 37)];

...
- (void)custom {
    ...
    [_borderView exSetBorder:[UIColor orangeColor] width:kJXBorderMiddle radius:kJXRadiusSmall];
...
- (void)configColor:(UIColor *)color{
    [_borderView exSetBorder:color width:kJXBorderMiddle radius:kJXRadiusSmall];

...
//#import "JXApple.h"
//
//#define JXLoadingViewForTableViewHpViewTag          (97417)
//
...
//        }
//        
//        UIView *hpView = [view.superview viewWithTag:JXLoadingViewForTableViewHpViewTag];
//        if (hpView) {
//            [JXLoadingView showProcessingAddedTo:hpView];
//            return;
//        }
//        
//        hpView = [[UIView alloc] init];
//        hpView.tag = JXLoadingViewForTableViewHpViewTag;
//        [view.superview addSubview:hpView];
...
//        }
//        
//        [JXLoadingView showFailedAddedTo:hpView image:image message:message retry:retry];
//        return;
//    }
//    
//    JXLoadingView *loadingView = [[self class] loadForView:view];
...
//        }
//        
//        [JXLoadingView hideForView:hpView];
//        [hpView removeFromSuperview];
//        hpView = nil;
//        return;
//    }
//    

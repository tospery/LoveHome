...
#else
#define JXToast(msg)                                            JXAlert(nil, msg)
#endif
...
//// Loading
//#define JXShowProcessing(superview)         [JXProcessView showProcessingAddedTo:(superview) activityProcessingViewColor:nil gifProcessingImageName:nil]
//#define JXShowFailed(superview, statements) [JXProcessView showFailedAddedTo:(superview) failedMessage:nil failedImageName:nil retry:^{statements;}]
//#define JXHideLoading(superview)            [JXProcessView hideForView:(superview)]


// HUD
#define JXHUD(msg)                                                          \
[MBProgressHUD showHUDAddedTo:self.view animated:YES hideAnimated:YES hideDelay:kTimeTips mode:MBProgressHUDModeText type:0 customView:nil labelText:nil detailsLabelText:(msg) square:NO dimBackground:NO color:nil removeFromSuperViewOnHide:NO labelFont:18.0f detailsLabelFont:14.0f];

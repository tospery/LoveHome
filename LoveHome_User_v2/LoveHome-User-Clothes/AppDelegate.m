...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [self setupUMUpdate];
    [self setupJSPatch];
    [WXApi registerApp:kWXAppID withDescription:@"LoveHome"];
...
- (BOOL)application:(UIApplication *)application handleOpenURL:(NSURL *)url {
    NSString *aaa = url.absoluteString;
    aaa = url.host;
    return  [UMSocialSnsService handleOpenURL:url];
}
...
- (void)loadViews {
    ...
    NSArray *controllers = @[[[LHHomeViewController alloc] init],
                             [[LHV2CartViewController alloc] init],
...
- (void)setupUMUpdate {
    // [UMCheckUpdate checkUpdateWithAppkey:kUMAppkey channel:nil];
...
//                break;
//        }
        [[NSNotificationCenter defaultCenter]  postNotificationName:kNotifyWxpayPayment object:resp userInfo:nil];
    }
}
@end

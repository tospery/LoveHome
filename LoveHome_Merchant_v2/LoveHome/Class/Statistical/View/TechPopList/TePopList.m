...
- (instancetype)initWithListDataSource:(NSArray *)source withSelectedBlock:(PopListSelectedBlock)selecteblock{
    ...
    if(self)
    {
        ...
        tableview = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width - 40, 0) style:UITableViewStylePlain];
        [tableview setDataSource:self];
        [tableview setDelegate:self];
        [self addSubview:tableview];
        tableview.layer.shadowColor = [UIColor clearColor].CGColor;
        ...
        CGSize size = CGSizeMake([UIScreen mainScreen].bounds.size.width - 40, TecellH*listcount);
        [tableview setFrame:CGRectMake(20, 100, size.width, size.height)];

...
- (IBAction)loginButton:(id)sender
{
   ...
   [UserTools loginWithPhone:_telePhone.text code:_codeLbale.text device:[NSNumber numberWithInteger:2] success:^(AFHTTPRequestOperation *operation, id responsObject) {
...
#warning 写死了
    ...
    vc.authDescription = user.authDescription;

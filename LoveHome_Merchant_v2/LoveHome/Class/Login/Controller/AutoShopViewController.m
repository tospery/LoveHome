...
- (void)viewDidLoad
{
    ...
    RegistShopModel *shop = [UserTools sharedUserTools].registShopModel;
...
- (void)submitAutoShopWithImages:(NSArray *)images
{
    ...
    [parmater removeObjectForKey:@"shopDescription"];
    [parmater removeObjectForKey:@"cityDistrict"];
    [parmater removeObjectForKey:@"serverCoverStr"];
    [parmater setValue:[[UserTools sharedUserTools].registShopModel getShopDesformat] forKey:@"shopDescription"];

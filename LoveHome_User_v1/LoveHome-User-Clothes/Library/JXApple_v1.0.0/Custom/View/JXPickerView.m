...
//    NSDateComponents *components = [calendar components:(NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitSecond) fromDate:dft];
//    
//    int dayIndex = 0;
//    if (components.hour > ) {
//        
//    }
//    int a = components.hour;
//    int b = components.minute;
//    int i = 0;
//    
//    [self.pickerView reloadAllComponents];
//    [self.pickerView selectRow:0 inComponent:0 animated:NO];
//    [self.pickerView selectRow:(components.hour - 9) inComponent:1 animated:NO];
...
//    unsigned int unitFlags = NSCalendarUnitMonth | NSCalendarUnitYear | NSCalendarUnitDay | NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitSecond | NSCalendarUnitWeekday;
...
//        [firsts addObject:[NSString stringWithFormat:@"%ld年", (long)i]];
//    }
}
